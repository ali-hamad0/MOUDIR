...
const ar = {
  ...
  // Phone OTP verification (step before sending the request)
  signupSendCode: "إبعتلي رمز التأكيد",
  signupSendingCode: "عم نبعت الرمز...",
  signupResendCode: "إبعت الرمز مرة تانية",
  signupOtpLabel: "رمز التأكيد",
  signupOtpHint: "بعتنالك رمز على الواتساب عـ {phone}. اكتبو هون.",
  signupChangePhone: "غيّر الرقم",
  signupInvalidPhone: "رقم الموبايل مش صحيح. تأكّد منه وجرّب مرة تانية.",
  signupOtpInvalid: "رمز التأكيد غلط أو خلص وقتو. اطلب رمز جديد.",
  signupOtpTooMany: "طلبت رموز كتير. استنى شوي وجرّب بعدين.",
  signupOtpSendError: "ما قدرنا نبعت الرمز. جرّب مرة تانية.",
  // Navigation
  navHome: "الرئيسية",
  navOrders: "الطلبات",
...
const en: Record<TranslationKey, string> = {
  ...
  // Phone OTP verification (step before sending the request)
  signupSendCode: "Send me a code",
  signupSendingCode: "Sending code...",
  signupResendCode: "Resend code",
  signupOtpLabel: "Verification code",
  signupOtpHint: "We sent a code on WhatsApp to {phone}. Enter it here.",
  signupChangePhone: "Change number",
  signupInvalidPhone: "That mobile number isn't valid. Check it and try again.",
  signupOtpInvalid: "The code is wrong or expired. Request a new one.",
  signupOtpTooMany: "Too many code requests. Wait a bit and try again.",
  signupOtpSendError: "Couldn't send the code. Try again.",
  // Navigation
  navHome: "Home",
  navOrders: "Orders",
